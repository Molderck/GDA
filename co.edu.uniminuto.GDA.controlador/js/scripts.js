...
(function ($) {
    ...
    jQuery(document).ready(function () {
        ...
        $(window).load(function () {
            $(".typing").typed({
                strings: ["¿Sabes que tan local o global son los alimentos que comes a diario?", "Registrate, agrega tus alimentos y genera tu GDA.", "Y reflexiona sobre cuanto viajan tus alimentos para llegar a tu mesa."], /* You can change the home section typing text from
