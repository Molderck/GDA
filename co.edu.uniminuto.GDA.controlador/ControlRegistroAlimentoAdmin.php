...
if ($registro1 == null) {
    $query = $conexion->query("INSERT INTO alimento VALUES('','" . $_POST['nombreAlimento'] . "','" . $_POST['tipologiaAlimento'] . "', '" . $_POST['continenteAlimento'] . "', '" . $_POST['paisAlimento'] . "', '" . $_POST['departamentoRegionAlimento'] . "', '" . $_POST{'ciudadMunicipioAlimento'} . "', '" . $_POST['placeIDAlimentoNuevo'] . "', '" . $_POST['ubicacionAlimentoNuevo'] . "', 'Aceptado');");
    ...
    if ($registro2 == null) {
        $query3 = $conexion->query("INSERT INTO alimento VALUES('','" . $_POST['nombreAlimento'] . "','" . $_POST['tipologiaAlimento'] . "', '" . $_POST['continenteAlimento'] . "', '" . $_POST['paisAlimento'] . "', '" . $_POST['departamentoRegionAlimento'] . "', '" . $_POST{'ciudadMunicipioAlimento'} . "', '" . $_POST['placeIDAlimentoNuevo'] . "', '" . $_POST['ubicacionAlimentoNuevo'] . "', 'Aceptado');");
        echo "document.getElementById('registroAlimentoExitoso').hidden = false;";
        echo "document.getElementById('registroAlimentoFallido').hidden = true;";
        echo "document.getElementById('registroAlimentoFallidoRepetido').hidden = true;";
    } else {
